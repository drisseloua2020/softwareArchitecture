...
@router.post("/users")
async def create_user(name: str, email: str, mobile: str, password: str, user_dal: UserDAL = Depends(get_user_dal)):
    return await user_dal.create_user(name, email, mobile, password)
